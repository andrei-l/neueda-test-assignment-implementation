 ...
 *       &lt;attribute name="DESTINATION" use="required" type="{http://www.w3.org/2001/XMLSchema}NCName" />
 *       &lt;attribute name="ENDARROW" use="required" type="{http://www.w3.org/2001/XMLSchema}NCName" />
 *       &lt;attribute name="ENDINCLINATION" use="required" type="{http://www.w3.org/2001/XMLSchema}anySimpleType" />
 *       &lt;attribute name="ID" use="required" type="{http://www.w3.org/2001/XMLSchema}NCName" />
 *       &lt;attribute name="SOURCE" use="required" type="{http://www.w3.org/2001/XMLSchema}NCName" />
 *       &lt;attribute name="STARTARROW" use="required" type="{http://www.w3.org/2001/XMLSchema}NCName" />
 *       &lt;attribute name="STARTINCLINATION" use="required" type="{http://www.w3.org/2001/XMLSchema}anySimpleType" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
public class Linktarget {
    ...
    @XmlAttribute(name = "ENDARROW", required = true)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "NCName")
    protected String endarrow;
    @XmlAttribute(name = "ENDINCLINATION", required = true)
    @XmlSchemaType(name = "anySimpleType")
    ...
    @XmlAttribute(name = "STARTARROW", required = true)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "NCName")
    protected String startarrow;
    @XmlAttribute(name = "STARTINCLINATION", required = true)
    @XmlSchemaType(name = "anySimpleType")
